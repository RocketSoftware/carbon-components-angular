...
import { InformationFilledModule } from "@rocketsoftware/icons-angular";
...
storiesOf("Components|Tooltip", module)
	...
	.add("Documentation", () => ({
		template: `
			<ibm-documentation src="documentation/classes/src_dialog_tooltip.tooltip.html"></ibm-documentation>
		`
	}));
